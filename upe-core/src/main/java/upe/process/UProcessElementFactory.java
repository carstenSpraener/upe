...
public interface UProcessElementFactory {
	...
	UProcessComponentList<UProcessComponent> newProcessComponentList(UProcessComponent parent, String peName, Class<? extends UProcessComponent> listElementClazz);
}
